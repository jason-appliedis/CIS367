...
switch($action){
    ...
    case 'addCustomer':
        ...
        if ($fields->hasErrors()) {
            ...
            Customer::addCustomer($customerFirstName, $customerLastName, $customerAddress, $customerCity, $customerState, $customerPostalCode, $customerCountryCode, $customerPhone,$customerEmail, $customerPassword);
            include('./customer_manager.php');
        }
        break;
    ...
    case 'updateCustomer':
        ...
        if ($fields->hasErrors()) {
            ...
            $customers = Customer::updateCustomer($customerID, $customerFirstName, $customerLastName, $customerAddress, $customerCity, $customerState, $customerPostalCode, $customerCountryCode, $customerPhone,$customerEmail, $customerPassword);
            include('./customer_manager.php');
        }
    break;
    case 'deleteCustomer':
