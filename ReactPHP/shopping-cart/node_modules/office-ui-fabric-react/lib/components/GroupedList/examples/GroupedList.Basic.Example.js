...
export var GroupedListBasicExample = function () {
    ...
    return (React.createElement("div", null,
        ...
        React.createElement(SelectionZone, { selection: selection, selectionMode: SelectionMode.multiple },
            React.createElement(GroupedList, { items: items, 
                // eslint-disable-next-line react/jsx-no-bind
                onRenderCell: onRenderCell, selection: selection, selectionMode: SelectionMode.multiple, groups: groups, compact: isCompactMode }))));
};
