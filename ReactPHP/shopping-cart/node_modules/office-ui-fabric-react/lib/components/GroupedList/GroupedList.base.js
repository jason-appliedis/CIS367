...
var GroupedListBase = /** @class */ (function (_super) {
    ...
    GroupedListBase.prototype.render = function () {
        ...
        return (React.createElement(FocusZone, { isInnerZoneKeystroke: this._isInnerZoneKeystroke, direction: FocusZoneDirection.vertical, className: this._classNames.root, "data-automationid": "GroupedList", "data-is-scrollable": "false", role: "presentation" }, !groups ? (this._renderGroup(undefined, 0)) : (React.createElement(List, { ref: this._list, role: "presentation", items: groups, onRenderCell: this._renderGroup, getItemCountForPage: this._returnOne, getPageHeight: this._getPageHeight, getPageSpecification: this._getPageSpecification, usePageCache: usePageCache, onShouldVirtualize: onShouldVirtualize, version: version }))));
    };
