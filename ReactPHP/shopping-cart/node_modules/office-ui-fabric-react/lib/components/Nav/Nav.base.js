...
var NavBase = /** @class */ (function (_super) {
    ...
    function NavBase(props) {
        ...
        _this._renderGroupHeader = function (group) {
            ...
            var onClick = onHeaderClick
                ...
                : undefined;
            return (React.createElement("button", { className: classNames.chevronButton, 
                // eslint-disable-next-line react/jsx-no-bind
                onClick: onClick, "aria-label": label, "aria-expanded": isExpanded },
    ...
    NavBase.prototype._renderCompositeLink = function (link, linkIndex, nestingLevel) {
        ...
        return (React.createElement("div", __assign({}, divProps, { key: link.key || linkIndex, className: classNames.compositeLink }),
            link.links && link.links.length > 0 ? (React.createElement("button", { className: classNames.chevronButton, 
                // eslint-disable-next-line react/jsx-no-bind
                onClick: this._onLinkExpandClicked.bind(this, link), "aria-label": finalExpandBtnAriaLabel, "aria-expanded": link.isExpanded ? 'true' : 'false' },
