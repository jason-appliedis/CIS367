define(["require", "exports", "tslib", "react", "../../Utilities", "./GroupedListSection", "../../List", "../../utilities/selection/index", "../DetailsList/DetailsRow.styles", "../../FocusZone"], function (require, exports, tslib_1, React, Utilities_1, GroupedListSection_1, List_1, index_1, DetailsRow_styles_1, FocusZone_1) {
    "use strict";
    ...
    var GroupedListBase = /** @class */ (function (_super) {
        ...
        GroupedListBase.prototype.render = function () {
            ...
            return (React.createElement(FocusZone_1.FocusZone, { isInnerZoneKeystroke: this._isInnerZoneKeystroke, direction: FocusZone_1.FocusZoneDirection.vertical, className: this._classNames.root, "data-automationid": "GroupedList", "data-is-scrollable": "false", role: "presentation" }, !groups ? (this._renderGroup(undefined, 0)) : (React.createElement(List_1.List, { ref: this._list, role: "presentation", items: groups, onRenderCell: this._renderGroup, getItemCountForPage: this._returnOne, getPageHeight: this._getPageHeight, getPageSpecification: this._getPageSpecification, usePageCache: usePageCache, onShouldVirtualize: onShouldVirtualize, version: version }))));
        };
