var FabricReactHooks=function(t){var e={};function n(r){if(e[r])return e[r].exports;var i=e[r]={i:r,l:!1,exports:{}};return t[r].call(i.exports,i,i.exports,n),i.l=!0,i.exports}return n.m=t,n.c=e,n.d=function(t,e,r){n.o(t,e)||Object.defineProperty(t,e,{enumerable:!0,get:r})},n.r=function(t){"undefined"!=typeof Symbol&&Symbol.toStringTag&&Object.defineProperty(t,Symbol.toStringTag,{value:"Module"}),Object.defineProperty(t,"__esModule",{value:!0})},n.t=function(t,e){if(1&e&&(t=n(t)),8&e)return t;if(4&e&&"object"==typeof t&&t&&t.__esModule)return t;var r=Object.create(null);if(n.r(r),Object.defineProperty(r,"default",{enumerable:!0,value:t}),2&e&&"string"!=typeof t)for(var i in t)n.d(r,i,function(e){return t[e]}.bind(null,i));return r},n.n=function(t){var e=t&&t.__esModule?function(){return t.default}:function(){return t};return n.d(e,"a",e),e},n.o=function(t,e){return Object.prototype.hasOwnProperty.call(t,e)},n.p="",n(n.s=3)}([function(t,e){t.exports=React},function(t,e,n){"use strict";n.d(e,"a",(function(){return o}));var r={},i=void 0;try{i=window}catch(t){}function o(t,e){if(void 0!==i){var n=i.__packages__=i.__packages__||{};if(!n[t]||!r[t])r[t]=e,(n[t]=n[t]||[]).push(e)}}o("@uifabric/set-version","6.0.0")},,function(t,e,n){"use strict";n.r(e),n.d(e,"useAsync",(function(){return l})),n.d(e,"useBoolean",(function(){return d})),n.d(e,"useConst",(function(){return c})),n.d(e,"useConstCallback",(function(){return f})),n.d(e,"useControllableValue",(function(){return m})),n.d(e,"useForceUpdate",(function(){return _})),n.d(e,"useId",(function(){return S})),n.d(e,"useMergedRefs",(function(){return C})),n.d(e,"useOnEvent",(function(){return k})),n.d(e,"usePrevious",(function(){return N})),n.d(e,"useRefEffect",(function(){return j})),n.d(e,"useSetInterval",(function(){return O})),n.d(e,"useSetTimeout",(function(){return A}));var r=n(1);Object(r.a)("@uifabric/react-hooks","7.6.3");var i=!1;var o=void 0;try{o=window}catch(t){}function s(t){if(!i&&void 0!==o){var e=t;return e&&e.ownerDocument&&e.ownerDocument.defaultView?e.ownerDocument.defaultView:o}}var u=function(){function t(t,e){this._timeoutIds=null,this._immediateIds=null,this._intervalIds=null,this._animationFrameIds=null,this._isDisposed=!1,this._parent=t||null,this._onErrorHandler=e,this._noop=function(){}}return t.prototype.dispose=function(){var t;if(this._isDisposed=!0,this._parent=null,this._timeoutIds){for(t in this._timeoutIds)this._timeoutIds.hasOwnProperty(t)&&this.clearTimeout(parseInt(t,10));this._timeoutIds=null}if(this._immediateIds){for(t in this._immediateIds)this._immediateIds.hasOwnProperty(t)&&this.clearImmediate(parseInt(t,10));this._immediateIds=null}if(this._intervalIds){for(t in this._intervalIds)this._intervalIds.hasOwnProperty(t)&&this.clearInterval(parseInt(t,10));this._intervalIds=null}if(this._animationFrameIds){for(t in this._animationFrameIds)this._animationFrameIds.hasOwnProperty(t)&&this.cancelAnimationFrame(parseInt(t,10));this._animationFrameIds=null}},t.prototype.setTimeout=function(t,e){var n=this,r=0;return this._isDisposed||(this._timeoutIds||(this._timeoutIds={}),r=setTimeout((function(){try{n._timeoutIds&&delete n._timeoutIds[r],t.apply(n._parent)}catch(t){n._onErrorHandler&&n._onErrorHandler(t)}}),e),this._timeoutIds[r]=!0),r},t.prototype.clearTimeout=function(t){this._timeoutIds&&this._timeoutIds[t]&&(clearTimeout(t),delete this._timeoutIds[t])},t.prototype.setImmediate=function(t,e){var n=this,r=0,i=s(e);if(!this._isDisposed){this._immediateIds||(this._immediateIds={});r=i.setTimeout((function(){try{n._immediateIds&&delete n._immediateIds[r],t.apply(n._parent)}catch(t){n._logError(t)}}),0),this._immediateIds[r]=!0}return r},t.prototype.clearImmediate=function(t,e){var n=s(e);this._immediateIds&&this._immediateIds[t]&&(n.clearTimeout(t),delete this._immediateIds[t])},t.prototype.setInterval=function(t,e){var n=this,r=0;return this._isDisposed||(this._intervalIds||(this._intervalIds={}),r=setInterval((function(){try{t.apply(n._parent)}catch(t){n._logError(t)}}),e),this._intervalIds[r]=!0),r},t.prototype.clearInterval=function(t){this._intervalIds&&this._intervalIds[t]&&(clearInterval(t),delete this._intervalIds[t])},t.prototype.throttle=function(t,e,n){var r=this;if(this._isDisposed)return this._noop;var i,o,s=e||0,u=!0,a=!0,c=0,l=null;n&&"boolean"==typeof n.leading&&(u=n.leading),n&&"boolean"==typeof n.trailing&&(a=n.trailing);var f=function(e){var n=(new Date).getTime(),d=n-c,m=u?s-d:s;return d>=s&&(!e||u)?(c=n,l&&(r.clearTimeout(l),l=null),i=t.apply(r._parent,o)):null===l&&a&&(l=r.setTimeout(f,m)),i};return function(){for(var t=[],e=0;e<arguments.length;e++)t[e]=arguments[e];return o=t,f(!0)}},t.prototype.debounce=function(t,e,n){var r=this;if(this._isDisposed){var i=function(){};return i.cancel=function(){},i.flush=function(){return null},i.pending=function(){return!1},i}var o,s,u=e||0,a=!1,c=!0,l=null,f=0,d=(new Date).getTime(),m=null;n&&"boolean"==typeof n.leading&&(a=n.leading),n&&"boolean"==typeof n.trailing&&(c=n.trailing),n&&"number"==typeof n.maxWait&&!isNaN(n.maxWait)&&(l=n.maxWait);var _=function(t){m&&(r.clearTimeout(m),m=null),d=t},h=function(e){_(e),o=t.apply(r._parent,s)},p=function(t){var e=(new Date).getTime(),n=!1;t&&(a&&e-f>=u&&(n=!0),f=e);var i=e-f,s=u-i,_=e-d,v=!1;return null!==l&&(_>=l&&m?v=!0:s=Math.min(s,l-_)),i>=u||v||n?h(e):null!==m&&t||!c||(m=r.setTimeout(p,s)),o},v=function(){return!!m},y=function(){for(var t=[],e=0;e<arguments.length;e++)t[e]=arguments[e];return s=t,p(!0)};return y.cancel=function(){v()&&_((new Date).getTime())},y.flush=function(){return v()&&h((new Date).getTime()),o},y.pending=v,y},t.prototype.requestAnimationFrame=function(t,e){var n=this,r=0,i=s(e);if(!this._isDisposed){this._animationFrameIds||(this._animationFrameIds={});var o=function(){try{n._animationFrameIds&&delete n._animationFrameIds[r],t.apply(n._parent)}catch(t){n._logError(t)}};r=i.requestAnimationFrame?i.requestAnimationFrame(o):i.setTimeout(o,0),this._animationFrameIds[r]=!0}return r},t.prototype.cancelAnimationFrame=function(t,e){var n=s(e);this._animationFrameIds&&this._animationFrameIds[t]&&(n.cancelAnimationFrame?n.cancelAnimationFrame(t):n.clearTimeout(t),delete this._animationFrameIds[t])},t.prototype._logError=function(t){this._onErrorHandler&&this._onErrorHandler(t)},t}(),a=n(0);function c(t){var e=a.useRef();return void 0===e.current&&(e.current={value:"function"==typeof t?t():t}),e.current.value}function l(){var t=c((function(){return new u}));return a.useEffect((function(){return function(){return t.dispose()}}),[t]),t}function f(t){var e=a.useRef();return e.current||(e.current=t),e.current}function d(t){var e=a.useState(t),n=e[0],r=e[1],i=a.useRef(n),o=f((function(){r(!0),i.current=!0})),s=f((function(){r(!1),i.current=!1})),u=f((function(){return i.current?s():o()}));return[n,{setTrue:o,setFalse:s,toggle:u}]}function m(t,e,n){var r=a.useState(e),i=r[0],o=r[1],s=c(void 0!==t),u=a.useCallback((function(t,e){n&&n(e,t),s||o(t)}),[n,s]);return[s?t:i,u]}function _(){var t=a.useState(0)[1];return f((function(){return t((function(t){return++t}))}))}
/*! *****************************************************************************
