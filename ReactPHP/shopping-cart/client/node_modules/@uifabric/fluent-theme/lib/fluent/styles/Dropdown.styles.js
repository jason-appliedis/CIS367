...
export var DropdownStyles = function (props) {
    ...
    return {
        ...
        dropdownItemDisabled: __assign(__assign({}, commonItemStyles), { color: palette.neutralTertiary }),
        dropdownItemSelectedAndDisabled: __assign(__assign({}, commonItemStyles), { color: palette.neutralTertiary }),
    };
};
