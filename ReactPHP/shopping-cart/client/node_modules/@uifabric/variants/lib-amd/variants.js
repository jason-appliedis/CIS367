define(["require", "exports", "tslib", "office-ui-fabric-react/lib/Styling", "./variantThemeType"], function (require, exports, tslib_1, Styling_1, variantThemeType_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    function makeThemeFromPartials(originalTheme, partialPalette, partialSemantic) {
        // Create variant palette
        var variantTheme = Styling_1.createTheme({ palette: tslib_1.__assign(tslib_1.__assign({}, originalTheme.palette), partialPalette) });
    ...
    function getStrongVariant(theme) {
        ...
        // Create variant palette
        var variantTheme = Styling_1.createTheme({ palette: tslib_1.__assign(tslib_1.__assign({}, fullTheme.palette), partialPalette) });
        // Change semantic colors to use updated variant palette values
        variantTheme.semanticColors = tslib_1.__assign(tslib_1.__assign({}, variantTheme.semanticColors), partialSemantic);
        // Fill in the rest of the theme
