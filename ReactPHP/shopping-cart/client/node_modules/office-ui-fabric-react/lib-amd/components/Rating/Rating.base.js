            ...
            for (var i = this._min; i <= max; i++) {
                if (i !== 0) {
                    ...
                    stars.push(React.createElement("button", tslib_1.__assign({ className: Utilities_1.css(this._classNames.ratingButton, (_a = {},
                            ...
                            _a)), id: starIds[i - 1], key: i }, (i === Math.ceil(rating) ? { 'data-is-current': true } : {}), { 
                        // eslint-disable-next-line react/jsx-no-bind
                        onFocus: this._onFocus.bind(this, i), 
                        // eslint-disable-next-line react/jsx-no-bind
                        onClick: this._onFocus.bind(this, i), disabled: disabled || readOnly ? true : false, role: "presentation", type: "button" }),
                        this._getLabel(i),
