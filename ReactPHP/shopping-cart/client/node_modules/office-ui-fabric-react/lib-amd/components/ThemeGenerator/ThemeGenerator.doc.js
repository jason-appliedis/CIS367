define(["require", "exports", "tslib", "react", "office-ui-fabric-react/lib/Styling", "office-ui-fabric-react/lib/utilities/color/shades", "office-ui-fabric-react/lib/ThemeGenerator", "office-ui-fabric-react/lib/Callout", "office-ui-fabric-react/lib/ColorPicker", "office-ui-fabric-react/lib/ChoiceGroup", "../../components/TeachingBubble/examples/TeachingBubble.Basic.Example", "../TextField/examples/TextField.Basic.Example", "../../components/Toggle/examples/Toggle.Basic.Example", "../ProgressIndicator/examples/ProgressIndicator.Basic.Example", "@uifabric/utilities"], function (require, exports, tslib_1, React, Styling_1, shades_1, ThemeGenerator_1, Callout_1, ColorPicker_1, ChoiceGroup_1, TeachingBubble_Basic_Example_1, TextField_Basic_Example_1, Toggle_Basic_Example_1, ProgressIndicator_Basic_Example_1, utilities_1) {
    ...
    var ThemeGeneratorPage = /** @class */ (function (_super) {
                ...
                return (React.createElement("div", null,
                    ...
                    React.createElement("div", { className: 'ms-themer-output-root' },
                        React.createElement("div", null,
                            ...
                            React.createElement("textarea", { readOnly: true, spellCheck: false, value: JSON.stringify(ThemeGenerator_1.ThemeGenerator.getThemeAsJson(abridgedTheme), undefined, 2) })),
                        React.createElement("div", null,
        ...
        ThemeGeneratorPage.prototype.render = function () {
            ...
            return (React.createElement("div", { className: "ms-themer" },
                ...
                colorPickerVisible && colorPickerSlotRule && colorPickerElement && (React.createElement(Callout_1.Callout, { key: colorPickerSlotRule.name, gapSpace: 10, target: colorPickerElement, setInitialFocus: true, onDismiss: this._colorPickerOnDismiss },
                    React.createElement(ColorPicker_1.ColorPicker, { color: colorPickerSlotRule.color.str, 
                        // eslint-disable-next-line react/jsx-no-bind
        ...
        ThemeGeneratorPage.prototype._colorSquareSwatchWidget = function (slotRule) {
            return (React.createElement("div", { key: slotRule.name, className: "ms-themer-swatch", style: { backgroundColor: slotRule.color.str }, 
                // eslint-disable-next-line react/jsx-no-bind
