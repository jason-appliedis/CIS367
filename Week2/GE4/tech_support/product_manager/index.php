...
switch($action){
    ...
    case 'addProductForm' :
        ...
        $productVersion = filter_input(INPUT_POST, 'productVersion', FILTER_VALIDATE_FLOAT); 
    ...
    case 'addProduct' :
        ...
        $validate->pattern('productReleaseDate',$productReleaseDate, $datePattern, $dateErrMsg,  true );
